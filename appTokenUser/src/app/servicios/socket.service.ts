...
//   private maxIntentosSubscribicionToken = 5;
//   private intentosSubscribicionToken = 0;
//   private topic = "";
...
//   public capturarTopic(rolUsuario: string) {
//     let roleGuardado = rolUsuario;
//     if (roleGuardado === "ROLE_ADMIN") {
//       this.topic = "/tema/admin/notificacion";
//     } else if (roleGuardado === "ROLE_USER") {
//       this.topic = "/tema/usuario/notificacion";
//     }
//   }

//   private iniciarConexionSocket(rolUsuario: string) {
//     this.capturarTopic(rolUsuario);
//     const url = "http://localhost:8080/websocket"; // Asegúrate de que la URL sea correcta
//     const socket = new SockJS(url);
//     this.stompClient = Stomp.over(socket);

//     this.stompClient.connect({}, () => {
//       console.log('Conexión WebSocket establecida');
//       this.suscribirseAlTopic(this.topic);
//     }, (error: any) => {
//       console.error('Error en la conexión WebSocket: ', error);
//     });
//   }

//   public suscribirseAlTopic(topic: string) {
//     if (this.stompClient && this.stompClient.connected) {
//       this.stompClient.subscribe(topic, (respuesta: any) => {
//         this.intentosSubscribicionToken = 0;
//         this.messageSubject.next(respuesta.body);
//         console.log(respuesta.body);
//       });
//     } else {
//       console.error('No se puede suscribir al tópico, WebSocket no está conectado');
//       this.resuscribcionToken(this.intentosSubscribicionToken, topic);
//       this.intentosSubscribicionToken++;
//     }
//   }

//   resuscribcionToken(intentos: number, topic: string) {
